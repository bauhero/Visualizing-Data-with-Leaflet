...
d3.json(URL, function(data) {
  // Getting a response, sending the data.features object to the createFeatures function
...
function createMap(earthquakes) {
  ...
  // Creating map, giving it the satelitemap and earthquakes layers to display on load
  var myMap = L.map("map", {
